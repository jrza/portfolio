...
function Exploring(){
    return (
        <div id="Learning" className="flex text-pink-500 min-h-full flex-col items-center bg-amber-50">
            ...
            <p className="text-black desktop:text-[30px] mobile:text-[18px] font-bold text-center mt-8 mb-4">Let&apos;s get in touch!</p> {/* Fixed apostrophe */}
